...
export default function ExampleModal({ type }: { type: string; }) {
  ...
  return (
    <Modal open={exampleModal} onClose={() => closeModal()}>
      <div className="justify-center min-w-[400px] mobile:min-w-[300px] flex p-10 rounded-3xl flex-col bg-lightBackground dark:bg-modalBackground top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 absolute focus-visible:outline-none">
