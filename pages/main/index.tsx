...
export default function Main(){
    return(
        <div className='bg-lightBack dark:bg-darkGray flex items-center justify-center flex-col w-full h-screen top-0 font-bold text-4xl dark:text-white'>
            ...
            <button className='dark:text-black flex items-center justify-center bg-[#61CDFE] w-[180px] h-[60px] mt-[12rem] rounded-4xl'>시작하기 <ArrowForwardIcon className='w-[25px] h-[25px]'/></button>
        </div>
    )
}